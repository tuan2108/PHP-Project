...
@section('content')
    ...
    <form name="product" action="{{ url("/backend/product/update/$product->id") }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            @endphp
            <input type="radio" name="product_status" id="product_status" value="2" {{$checkedRadioStatus}}>Tạm thời ngừng bán
        ...
        <div class="form-group">
            ...
            <div>
                <img src="{{ asset("storage/$product->product_image") }}" style="with:200px; height: auto" alt=""/>
            </div>
            @endif
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="product_desc" class="form-control" rows="7" id="product_desc">{{ $product->product_desc }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="product_publish"
            value="{{ $product->product_publish }}" style="width:250px" class="form-control" id="product_publish">
        </div>
