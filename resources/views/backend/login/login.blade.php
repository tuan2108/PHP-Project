                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="adminlogin" action="{{url('/backend/admin-login') }}" method="post">
                                    @csrf
                                        ...
                                        <input type="submit" name="submit" value="Login" class="btn bttn-primary btn-user btn-block">
                                        <hr>
